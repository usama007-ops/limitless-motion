...
import { Activity, Clock, RefreshCw, Loader2 } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Badge } from '@/components/ui/badge';
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from '@/components/ui/accordion';
import { getWorkoutPrograms, getWorkoutDays, getExercisesByDay } from '@/db';
        ...
        <div className="mb-12">
          ...
          {loading ? (
            ...
            <div className="space-y-6">
              {days?.map((day, idx) => (
                <motion.div key={day.day || idx} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: idx * 0.1 }}>
