...
import { Utensils, Droplets, Calculator, Apple, Flame, Globe, Leaf, Beef, Loader2 } from 'lucide-react';
import { useRouter } from 'next/navigation';
import { Card, CardContent, CardHeader, CardTitle, CardDescription } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { Badge } from '@/components/ui/badge';
import { getHighProteinMeals, getMealRecipesBySeason } from '@/db';

const fallbackGlobal = [
  { name: "Grilled Chicken Breast with Roasted Vegetables", cal: 350, imageUrl: "https://horizons-cdn.hostinger.com/c08aaf74-fefb-4823-ab59-73a42ac7ff97/4b3a5ba244e9b2561c2aa280d088526c.png" },
  { name: "Salmon with Sweet Potato", cal: 420, imageUrl: "https://horizons-cdn.hostinger.com/c08aaf74-fefb-4823-ab59-73a42ac7ff97/60abc79e0550b5308ea7db3875ad88f3.png" },
  { name: "Lean Beef with Brown Rice", cal: 450, imageUrl: "https://horizons-cdn.hostinger.com/c08aaf74-fefb-4823-ab59-73a42ac7ff97/ca0a0e38f41f6e86682c4fa70cb6e4b4.png" },
  { name: "Egg White Omelet with Vegetables", cal: 200, imageUrl: "https://horizons-cdn.hostinger.com/c08aaf74-fefb-4823-ab59-73a42ac7ff97/4b3a5ba244e9b2561c2aa280d088526c.png" },
];

const fallbackFasting = [
  { name: "Misir Wot", cal: 320, imageUrl: "https://horizons-cdn.hostinger.com/c08aaf74-fefb-4823-ab59-73a42ac7ff97/104d3afc679fac0dfc834200dfb0818c.png" },
  { name: "Shiro", cal: 280, imageUrl: "https://horizons-cdn.hostinger.com/c08aaf74-fefb-4823-ab59-73a42ac7ff97/51e8e0fc94feb6cb0c1daf189b374090.png" },
  { name: "Gomen", cal: 120, imageUrl: "https://horizons-cdn.hostinger.com/c08aaf74-fefb-4823-ab59-73a42ac7ff97/9cf53ff3b3513ab6de2744c830fcd203.png" },
  { name: "Kik Alicha", cal: 290, imageUrl: "https://horizons-cdn.hostinger.com/c08aaf74-fefb-4823-ab59-73a42ac7ff97/ca0a0e38f41f6e86682c4fa70cb6e4b4.png" },
];

const fallbackNonFasting = [
  { name: "Doro Wot", cal: 450, imageUrl: "https://horizons-cdn.hostinger.com/c08aaf74-fefb-4823-ab59-73a42ac7ff97/104d3afc679fac0dfc834200dfb0818c.png" },
  { name: "Kitfo", cal: 420, imageUrl: "https://horizons-cdn.hostinger.com/c08aaf74-fefb-4823-ab59-73a42ac7ff97/ca0a0e38f41f6e86682c4fa70cb6e4b4.png" },
  { name: "Tibs", cal: 350, imageUrl: "https://horizons-cdn.hostinger.com/c08aaf74-fefb-4823-ab59-73a42ac7ff97/9cf53ff3b3513ab6de2744c830fcd203.png" },
  { name: "Doro Tibs", cal: 320, imageUrl: "https://horizons-cdn.hostinger.com/c08aaf74-fefb-4823-ab59-73a42ac7ff97/51e8e0fc94feb6cb0c1daf189b374090.png" },
];

function mapHighProteinMeal(m) {
  return { name: m.name, cal: Number(m.calories_total) || 0, imageUrl: null };
}

function mapRecipeMeal(m) {
  return { name: m.name, cal: Number(m.calories_total) || 0, imageUrl: null };
}
...
const FuelPage = () => {
  ...
  const [globalMeals, setGlobalMeals] = useState(null);
  const [fastingMeals, setFastingMeals] = useState(null);
  const [nonFastingMeals, setNonFastingMeals] = useState(null);
  ...
  async function loadMeals() {
    try {
      const [highProtein, fastingRecipes, nonFastingRecipes] = await Promise.all([
        getHighProteinMeals(),
        getMealRecipesBySeason('fasting'),
        getMealRecipesBySeason('non-fasting'),
      ]);
      if (highProtein?.length) setGlobalMeals(highProtein.map(mapHighProteinMeal));
      if (fastingRecipes?.length) setFastingMeals(fastingRecipes.map(mapRecipeMeal));
      if (nonFastingRecipes?.length) setNonFastingMeals(nonFastingRecipes.map(mapRecipeMeal));
    } catch (err) {
      console.error('Failed to load meals from DB, using fallback:', err);
    } finally {
      setLoading(false);
    }
  }

  const displayGlobal = globalMeals || fallbackGlobal;
  const displayFasting = fastingMeals || fallbackFasting;
  const displayNonFasting = nonFastingMeals || fallbackNonFasting;
