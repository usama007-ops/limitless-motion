...
const fields = [
  ...
  { name: 'goal', label: 'Goal', type: 'text', placeholder: 'e.g. Build strength, Lose weight, Improve flexibility' },
  ...
  { name: 'target_audience', label: 'Target Audience', type: 'text', placeholder: 'e.g. All levels, Beginners, Advanced' },
