...
export default function EditHighProteinMeal() {
  ...
  const fetchData = useCallback(async () => {
    try { const data = await getHighProteinMeals(); const found = (data || []).find((v) => v.id === params.id); if (!found) throw new Error('Not found'); setItem(found) }
